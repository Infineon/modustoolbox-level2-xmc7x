...
int main(void)
{
	...
	{
		.intrSrc      =(NvicMux0_IRQn << 16)|cpuss_interrupts_dmac_0_IRQn,
	...
	Cy_DMAC_Descriptor_SetSrcAddress(&MY_DMA_Descriptor_0, (void *) bookArray);
	Cy_DMAC_Descriptor_SetDstAddress(&MY_DMA_Descriptor_0, (void *) bookArrayCopied);
	...
	Cy_SCB_UART_PutString(DEBUG_UART_HW, "ModusToolbox Level 2 - XMC7000 - Copying an array of structs\r\n");
	Cy_SCB_UART_PutString(DEBUG_UART_HW, "************************************************************\r\n\n");
