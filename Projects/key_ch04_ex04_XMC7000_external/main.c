...
* Global Vars
*******************************************************************************/
uint32_t startOfFlashGlobal = 0x60000000; // Start of external flash memory in global address space
...
int main(void)
{
	...
	Cy_DMA_Descriptor_SetSrcAddress(&DMA_UART_Descriptor_0, (void *) startOfFlashGlobal);
	Cy_DMA_Descriptor_SetDstAddress(&DMA_UART_Descriptor_0, (void *) buffer_r);
	...
	Cy_SCB_UART_PutString(DEBUG_UART_HW, "ModusToolbox Level 2 - XMC - Read from external flash using DMA\r\n");
	Cy_SCB_UART_PutString(DEBUG_UART_HW, "************************************************************\r\n\n");
